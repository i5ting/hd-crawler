...
var current_book = { }
var bar
var download_path = 'dist'
var processing = function (current, count) {
...
function one(book, chapter, processing){
  debug(chapter)
