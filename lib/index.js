...
function one(book, chapter, download_path, processing){
  ...
  if(require('fs').existsSync(download_path + '/' + arr[0] +'/' + arr[1] + '/' + chapter.num + '.html')){
    console.log('exist')
    ...
    console.log(__dirname + '/dist/' + arr[0] +'/' + arr[1] + '/' + chapter.num + '.html exist...')
  } else {
    c.queue([{
      uri: 'http://www.biquku.com/' + arr[0] +'/' + arr[1] + '/' + chapter.num + '.html',
      jQuery: jsdom,
      forceUTF8:true,
